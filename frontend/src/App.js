  ...
  return (
    <div className="bg-slate-900  min-h-screen">
      ...
      <svg width="20" height="20" mlns="http://www.w3.org/2000/svg" viewBox="0 0 12px 12px">
        ...
        <h1 className='text-white font-bold text-3xl pl-1.5'>Gibbrish</h1>
      </header>
      ...
      <body>
       ...
       <div class="grid grid-cols-3 gap-2 place-content-center h-screen">
         ...
         <div class="pl-64"> 
            <button class="bg-white hover:bg-sky-700 h-16 w-60 rounded-lg"> 
              <p class="text-black font-extrabold text-4xl">Translate</p>
            </button>
         ...
         <div class = "p-0"> 
            <button class="bg-white hover:bg-sky-700 h-16 w-60 rounded-lg">
              <p class="text-black font-extrabold text-4xl">Simplify</p>
            </button>
          </div>
